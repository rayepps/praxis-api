locals {
  ...
  log_group_arn_regional = var.existing_cloudwatch_log_group_arn
  log_group_name         = var.existing_cloudwatch_log_group_name
  log_group_arn          = var.existing_cloudwatch_log_group_arn
